...
object GoalioColors {
    ...
    val Black600 = Color(0xFF1C1C1C)
    val Black500 = Color(0xFF242424)
    val Black400 = Color(0xFF2F2F2F)
    val Gray300 = Color(0xFF5A5A5A)
    ...
    val Body = Color(0xFFC8C8C8)
    val Caption = Color(0xFF888888)
    val SmallLabel = Color(0xFF5A5A5A)
    val ProgressBackground = Color(0xFF2A2A2A)
}
